    ...
    implements Pimcore_API_Plugin_Interface
{
    ...
    public static function install()
    {
        ...
        if (self::isInstalled()) {
            return "CustomPanel successfully installed.";
        } else {
            return "CustomPanel could not be installed";
        }
    }
    ...
    public static function uninstall()
    {
        ...
        if (!self::isInstalled()) {
            return "CustomPanel successfully uninstalled.";
        } else {
            return "CustomPanel Plugin could not be uninstalled";
        }
    }
